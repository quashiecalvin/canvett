...
export default function ParseReceipt({ receipt, jobTitle }) {
  ...
  const labelClass = "text-[13px] font-semibold uppercase tracking-[0.05em] text-text-hint"
  ...
  return (
    <div className="flex flex-col gap-5 p-6">
      ...
      <div>
        <h2 className={labelClass}>What we read from your application</h2>
      ...
      <div className="grid gap-5 lg:grid-cols-3">
        <div className={cardClass}>
          ...
          {matched.length > 0 ? (
            ...
            <p className="mt-3 text-[13px] text-text-hint">
        ...
        <div className={cardClass}>
          ...
          {unmatched.length > 0 ? (
            <>
              ...
              <p className="mt-3 text-[12.5px] leading-relaxed text-text-hint">
                If you do have these, they may be worded differently in your CV.
              </p>
            </>
          ) : (
            <p className="mt-3 text-[13px] text-text-hint">
              Every skill listed for this role was found in your application.
            </p>
          )}
        </div>
        ...
        <div className={cardClass}>
          ...
          {receipt.duration_verified ? (
            <p className="mt-3 flex items-start gap-1.5 text-[13px] text-success-text">
              <CalendarCheck size={14} className="mt-0.5 shrink-0" />
              Your dates were read successfully.
            </p>
          ) : (
            <p className="mt-3 flex items-start gap-1.5 text-[13px] leading-relaxed text-score-amber">
      ...
      <div className={cardClass}>
        ...
        {showText && (
          <pre className="mt-4 max-h-96 overflow-auto whitespace-pre-wrap rounded-lg border border-border bg-bg-subtle p-4 font-sans text-[12.5px] leading-relaxed text-text-body">
